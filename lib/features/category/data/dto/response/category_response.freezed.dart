...
class _$_CategoryResponse implements _CategoryResponse {
  ...
  @override
  String toString() {
    return 'CategoryResponse(id: $id, name: $name, description: $description, thumbnail: $thumbnail, image: $image, isActive: $isActive, deletedAt: $deletedAt, createdAt: $createdAt, updatedAt: $updatedAt)';
  }
